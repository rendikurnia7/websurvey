...
$data = query("select * from quisioner  where Prodi='S1 Teknik Elektro'");
...
<head>
<meta charset="UTF-8">
<title> Report User Survey S1 Teknik Elektro</title>
<link rel="stylesheet" href="css/stylePDF.css">

</head>

<body>
<h1>Report User Survey S1 Teknik Elektro</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner S1 Teknik Elektro.pdf', 'I');
