...
?>
	...
	<div class="col-xl-6 col-lg-1">
					...
					data: [
					<?php 
					$sangatBaik = mysqli_query($connection,"SELECT * from quisioner where pengembanganDiri='4' AND Prodi='S1 Teknik Elektro'");
					echo mysqli_num_rows($sangatBaik);
					?>, 
					<?php 
					$Baik = mysqli_query($connection,"SELECT * from quisioner where pengembanganDiri='3' AND Prodi='S1 Teknik Elektro'");
					echo mysqli_num_rows($Baik);
					?>, 
					<?php 
					$Cukup = mysqli_query($connection,"SELECT * from quisioner where pengembanganDiri='2' AND Prodi='S1 Teknik Elektro'");
					echo mysqli_num_rows($Cukup);
					?>, 
					<?php 
					$Kurang = mysqli_query($connection,"SELECT * from quisioner where pengembanganDiri='1' AND Prodi='S1 Teknik Elektro'");
					echo mysqli_num_rows($Kurang);
					?>
					],
					backgroundColor: [
