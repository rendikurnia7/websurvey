...
$data = query("select * from quisioner  where Prodi='S1 Teknik Sipil'");
...
<head>
<meta charset="UTF-8">
<title> Report User Survey S1 Teknik Sipil</title>
</head>
<style>
.tc {
    text-align: center;
...
<body>
<h1>Report User Survey S1 Teknik Sipil</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner S1 Teknik Sipil.pdf', 'I');
