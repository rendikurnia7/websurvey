...
$data = query("select * from quisioner  where Prodi='D3 Teknik Elektro' AND Tanggal LIKE '%2021%'");
...
<title> Report User Survey D3 Teknik Elektro 2021</title>
</head>


<body>
<h1>Report User Survey D3 Teknik Elektro 2021</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner D3 Teknik Elektro 2021.pdf', 'I');
