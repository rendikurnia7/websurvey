...
$data = query("select * from quisioner  where Prodi='S1 Teknik Elektro' AND Tanggal LIKE '%2021%'");
...
<head>
<meta charset="UTF-8">
<title> Report User Survey S1 Teknik Elektro 2021</title>
<link rel="stylesheet" href="css/stylePDF.css">

</head>

<body>
<h1>Report User Survey S1 Teknik Elektro 2021</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner S1 Teknik Elektro 2021.pdf', 'I');
