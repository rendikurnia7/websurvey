...
$data = query("select * from quisioner  where Prodi='S2 Teknik Elektro' AND Tanggal LIKE '%2022%'");
...
<head>
<meta charset="UTF-8">
<title> Report User Survey S2 Teknik Elektro 2022</title>
<link rel="stylesheet" href="css/stylePDF.css">
</head>

<body>
<h1>Report User Survey S2 Teknik Elektro 2022</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner S2 Teknik Elektro 2022.pdf', 'I');
