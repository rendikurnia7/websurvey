...
$data = query("select * from quisioner  where Prodi='D3 Teknik Elektro' AND Tanggal LIKE '%2024%'");
...
<head>
<meta charset="UTF-8">
<title> Report User Survey D3 Teknik Elektro 2024</title>
<link rel="stylesheet" href="css/stylePDF.css">
</head>

<body>
<h1>Report User Survey D3 Teknik Elektro 2024</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner D3 Teknik Elektro 2024.pdf', 'I');
