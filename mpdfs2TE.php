...
$data = query("select * from quisioner  where Prodi='S2 Teknik Elektro'");
...
<head>
<meta charset="UTF-8">
<title> Report User Survey S2 Teknik Elektro</title>
<link rel="stylesheet" href="css/stylePDF.css">

</head>

<body>
<h1>Report User Survey S2 Teknik Elektro</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner S2 Teknik Elektro.pdf', 'I');
