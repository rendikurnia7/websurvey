...
<div class="container-fluid table-responsive">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="spreadSheetQuisioners1TI2023.php" target="_blank" name="export"type="submit" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50" ></i> Generate Report to Excel</a>
                                
        </div>
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h5 class="h5 mb-0 text-gray-800">S1 Teknik Informatika</h5>
        <a href="mpdfs1TI2023.php" target="_blank" name="export"type="submit" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
...
<button class="btn btn-info" type="submit" name="selectTahuns1TI">Select</button>
</div>
</form>
...
$no=1;
$query = "select * from quisioner where Prodi='S1 Teknik Informatika' AND Tanggal LIKE '%2023%'";
