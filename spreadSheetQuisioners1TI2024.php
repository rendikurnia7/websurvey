...
$query = mysqli_query($connection,"select * from quisioner where Prodi='S1 Teknik Informatika' AND Tanggal LIKE '%2024%'");
$i = 4;
$no = 1;
...
$sheet->addChart($chart3);
    ...
    $writer->save('Data Quisioner S1 Teknik Informatika 2024.xlsx');

    echo "<script>window.location = 'Data Quisioner S1 Teknik Informatika 2024.xlsx'</script>";
?>