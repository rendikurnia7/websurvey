...
$query = mysqli_query($connection,"select * from quisioner where Prodi='S1 Teknik Sipil'");
$i = 4;
$no = 1;
...
$sheet->addChart($chart3);
    ...
    $writer->save('Data Quisioner S1 Teknik Sipil.xlsx');

    echo "<script>window.location = 'Data Quisioner S1 Teknik Sipil.xlsx'</script>";
?>