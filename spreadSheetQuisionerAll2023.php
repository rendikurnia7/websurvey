...
$query = mysqli_query($connection,"select * from quisioner where Tanggal LIKE '%2023%'");
$i = 4;
$no = 1;
...
$sheet->addChart($chart3);
    ...
    $writer->save('Data Quisioner ALL 2023.xlsx');

    echo "<script>window.location = 'Data Quisioner ALL 2023.xlsx'</script>";
?>