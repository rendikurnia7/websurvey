...
$query = mysqli_query($connection,"select * from quisioner where Prodi='S1 Teknik Sipil' AND Tanggal LIKE '%2023%'");
$i = 4;
$no = 1;
...
$sheet->addChart($chart3);
    ...
    $writer->save('Data Quisioner S1 Teknik Sipil 2023.xlsx');

    echo "<script>window.location = 'Data Quisioner S1 Teknik Sipil 2023.xlsx'</script>";
?>