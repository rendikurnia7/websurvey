...
<label for="cari">Search by Penggunaan Teknologi Informasi (4/3/2/1)</label>
<br>
...
<div>
<form class="user" action="searchbyPenggunaanTeknologiInformasi.php" method="GET">
...
if(isset($_GET['cari'])){
	$cari = $_GET['cari'];
	echo "<b>Hasil pencarian Penggunaan Teknologi Informasi Bernilai : ".$cari."</b>";
}
...
?>
  ...
  <table class="table table-bordered" id="dataTable" width= 100% cellspacing="0">
        ...
        <tbody>
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $data = mysqli_query($connection,"select * from quisioner where penggunaanTeknologiInformasi LIKE '%$cari%'");				
            }else{
