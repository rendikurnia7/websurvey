...
$query = mysqli_query($connection,"select * from quisioner where Prodi='S1 Teknik Mesin'");
$i = 4;
$no = 1;
...
$sheet->addChart($chart2);
    ...
    $writer->save('Data Quisioner S1 Teknik Mesin.xlsx');
    
    echo "<script>window.location = 'Data Quisioner S1 Teknik Mesin.xlsx'</script>";
    ?>