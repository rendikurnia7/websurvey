...
<li class="nav-item active">
  <a class="nav-link" href="dasboardA.php">
...
<li class="nav-item">
  <a class="nav-link" href="registerA.php">
...
<li class="nav-item">
  ...
  <div id="collapseTables" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="dataQuisionerd3TE.php"> <i class="fa fa-fw fa-chart-area"></i> D3 Teknik Elektro</a>
      <a class="collapse-item" href="dataQuisioners1TI.php"> <i class="fa fa-fw fa-chart-area"></i> S1 Teknik Informatika</a>
