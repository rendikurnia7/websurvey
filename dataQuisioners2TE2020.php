...
<div class="container-fluid table-responsive">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="spreadSheetQuisioners2TE2020.php" target="_blank" name="export"type="submit" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
        ...
        <a href="mpdfs2TE2020.php" target="_blank" name="export"type="submit" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
...
<select name="tahun" id="tahun">
  ...
  <option name="tahun" value="2020" selected>2020</option>
...
$no=1;
$query = "select * from quisioner where Prodi='S2 Teknik Elektro' AND Tanggal LIKE '%2020%'";
