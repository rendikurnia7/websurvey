...
$data = query("select * from quisioner  where Prodi='S1 Teknik Mesin' AND Tanggal LIKE '%2021%'");
...
<head>
<meta charset="UTF-8">
<title> Report User Survey S1 Teknik Mesin 2021</title>
...
<body>
<h1>Report User Survey S1 Teknik Mesin 2021</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner S1 Teknik Mesin 2021.pdf', 'I');
