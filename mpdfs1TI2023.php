...
$data = query("select * from quisioner  where Prodi='S1 Teknik Infotmatika' AND Tanggal LIKE '%2023%'");
...
<head>
<meta charset="UTF-8">
<title> Report User Survey S1 Teknik Infotmatika 2023</title>
<link rel="stylesheet" href="css/stylePDF.css">
</head>

<body>
<h1>Report User Survey S1 Teknik Infotmatika 2023</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner S1 Teknik Informatika 2023.pdf', 'I');
