...
<div class="container-fluid table-responsive">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="spreadSheetQuisioners2TE2022.php" target="_blank" name="export"type="submit" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50" ></i> Generate Report to Excel</a>
                                
        </div>
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h5 class="h5 mb-0 text-gray-800">S2 Teknik Elektro</h5>
        <a href="mpdfs2TE2022.php" target="_blank" name="export"type="submit" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
...
<select name="tahun" id="tahun">
  ...
  <option name="tahun" value="2019">2019</option>
  <option name="tahun" value="2020">2020</option>
  <option name="tahun" value="2021">2021</option>
  <option name="tahun" value="2022" selected>2022</option>
  <option name="tahun" value="2023">2023</option>
  <option name="tahun" value="2024">2024</option>
</select>
<button class="btn btn-info" type="submit" name="selectTahuns2TE">Select</button>
</div>
</form>
...
$no=1;
$query = "select * from quisioner where Prodi='S2 Teknik Elektro' AND Tanggal LIKE '%2022%'";
