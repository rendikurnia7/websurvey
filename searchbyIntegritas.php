...
<label for="prodi">Search by Integritas (4/3/2/1)</label>
<br>
<label for="prodi">Nilai 4 = Sangat Baik | </label>
<label for="prodi">Nilai 3 = Baik | </label>
<label for="prodi">Nilai 2 = Cukup | </label>
<label for="prodi">Nilai 1 = Kurang</label>
<div>
<form class="user" action="searchbyIntegritas.php" method="GET">
...
if(isset($_GET['cari'])){
	$cari = $_GET['cari'];
	echo "<b>Hasil pencarian Integritas Bernilai : ".$cari."</b>";
}
...
?>
  ...
  <table class="table table-bordered" id="dataTable" width= 100% cellspacing="0">
        ...
        <tbody>
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $data = mysqli_query($connection,"select * from quisioner where Integritas LIKE '%$cari%'");				
            }else{
