...
$query = mysqli_query($connection,"select * from quisioner where Tanggal LIKE '%2022%'");
$i = 4;
$no = 1;
...
$sheet->addChart($chart2);
    ...
    $writer->save('Data Quisioner ALL 2022.xlsx');

    echo "<script>window.location = 'Data Quisioner ALL 2022.xlsx'</script>";
?>