...
$query = mysqli_query($connection,"select * from quisioner where Prodi='D3 Teknik Elektro' AND Tanggal LIKE '%2023%'");
$i = 4;
$no = 1;
...
$sheet->addChart($chart3);
    ...
    $writer->save('Data Quisioner D3 Teknik ELektro 2023.xlsx');

    echo "<script>window.location = 'Data Quisioner D3 Teknik ELektro 2023.xlsx'</script>";
?>