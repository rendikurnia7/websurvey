...
<label for="cari">Search by Kemampuan Berbahasa Asing (4/3/2/1)</label>
<br>
...
<div>
<form class="user" action="searchbyKemampuanBerbahasaAsing.php" method="GET">
...
if(isset($_GET['cari'])){
	$cari = $_GET['cari'];
	echo "<b>Hasil pencarian Kemampuan Berbahasa Asing Bernilai : ".$cari."</b>";
}
...
?>
  ...
  <table class="table table-bordered" id="dataTable" width= 100% cellspacing="0">
        ...
        <tbody>
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $data = mysqli_query($connection,"select * from quisioner where kemampuanBerbahasaAsing LIKE '%$cari%'");				
            }else{
