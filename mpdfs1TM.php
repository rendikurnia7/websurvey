...
$data = query("select * from quisioner  where Prodi='S1 Teknik Mesin'");
...
<body>
<h1>Report User Survey S1 Teknik Mesin</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner S1 Teknik Mesin.pdf', 'I');
