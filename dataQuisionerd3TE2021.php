...
<div class="container-fluid table-responsive">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="spreadSheetQuisionerd3TE2021.php" target="_blank" name="export"type="submit" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
        ...
        <a href="mpdfd3TE2021.php" target="_blank" name="export"type="submit" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
...
$no=1;
$query = "select * from quisioner where Prodi='D3 Teknik Elektro' AND Tanggal LIKE '%2021%' ";
