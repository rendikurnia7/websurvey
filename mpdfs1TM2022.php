...
$data = query("select * from quisioner  where Prodi='S1 Teknik Mesin' AND Tanggal LIKE '%2022%'");
...
<head>
<meta charset="UTF-8">
<title> Report User Survey S1 Teknik Mesin 2022</title>
<link rel="stylesheet" href="css/stylePDF.css">
</head>

<body>
<h1>Report User Survey S1 Teknik Mesin 2022</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner S1 Teknik Mesin 2022.pdf', 'I');
