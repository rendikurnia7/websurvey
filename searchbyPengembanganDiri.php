...
<label for="cari">Search by Pengembangan Diri (4/3/2/1)</label>
<br>
...
<div>
<form class="user" action="searchbyPengembanganDiri.php" method="GET">
...
if(isset($_GET['cari'])){
	$cari = $_GET['cari'];
	echo "<b>Hasil pencarian Pengembangan Diri Bernilai : ".$cari."</b>";
}
...
?>
  ...
  <table class="table table-bordered" id="dataTable" width= 100% cellspacing="0">
        ...
        <tbody>
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $data = mysqli_query($connection,"select * from quisioner where pengembanganDiri LIKE '%$cari%'");				
            }else{
