...
$data = query("select * from quisioner where Tanggal LIKE '%2023%'");
...
<head>
<meta charset="UTF-8">
<title>Report User Survey All 2023</title>
...
<body>
<h1>Report User Survey All 2023</h1>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Report Data Quisioner ALL 2023.pdf', 'I');
